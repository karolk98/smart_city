 ...
 * @version $Revision: 1 $
 */
public class AdaptiveRandomForestByDu extends AbstractClassifier implements MultiClassClassifier {
    ...
    public FlagOption disableDriftDetectionOption = new FlagOption("disableDriftDetection", 'z',
  ...
  //********************************************************************************
    ...
    public void resetLearningImpl() {
        ...
        if(numberOfJobs != AdaptiveRandomForestByDu.SINGLE_THREAD && numberOfJobs != 1)
    ...
    public double[] getVotesForInstance(Instance instance) {
        ...
        //****************************************************************
        //Evaluation Only		
        this.evaluateModel.evaluation(instance, combinedVote);
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
        ...
        switch(this.mFeaturesModeOption.getChosenIndex()) {
            case AdaptiveRandomForestByDu.FEATURES_SQRT:
                this.subspaceSize = (int) Math.round(Math.sqrt(n)) + 1;
                break;
            case AdaptiveRandomForestByDu.FEATURES_SQRT_INV:
                this.subspaceSize = n - (int) Math.round(Math.sqrt(n) + 1);
                break;
            case AdaptiveRandomForestByDu.FEATURES_PERCENT:
