...
public abstract class TransBlastAbstract extends AbstractClassifier implements MultiClassClassifier {
    ...
    public ListOption baselearnersOption = new ListOption("baseClassifiers", 'b',
            ...
            new ClassOption("learner", ' ', "", Classifier.class,
                    "trees.HoeffdingTree"),
            new Option[]{
                    new ClassOption("", ' ', "", Classifier.class, "meta.StreamingRandomPatches"),
                    new ClassOption("", ' ', "", Classifier.class, "meta.Melanie -b meta.StreamingRandomPatches"),
                    new ClassOption("", ' ', "", Classifier.class, "meta.Melanie2 -b meta.StreamingRandomPatches"),
                    new ClassOption("", ' ', "", Classifier.class, "meta.Smelanie"),
            },
            ',');

    public IntOption transfer = new IntOption("transferOption", 't',
            "Index of first transfer learning model", 1, 0,
            Integer.MAX_VALUE);
