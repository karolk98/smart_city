 ...
 *
 */
public class Smelanie extends AbstractClassifier implements MultiClassClassifier{
	...
	public void trainOnInstanceImpl(Instance inst) {
    	...
    	if(!this.numberOfSource.contains(sn)) {
			...
			this.newBaseLeaner.trainOnInstance(instTmp);
    	}
...
//		System.out.println("len: " + combinedVote.getArrayRef().length);
