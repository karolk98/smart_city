...
//        System.out.println("len: " + combinedVote.getArrayRef().length);
    ...
    protected void initEnsemble(Instance instance) {
        System.out.println("Init ensemble");
        // Init the ensemble.
...
//    }
    ...
    public Classifier[] getSublearners() {
        ...
        Classifier[] baseModels = new Classifier[this.ensemble==null?0:this.ensemble.length];
    ...
    public Classifier[] getSubClassifiers()  {
        if(this.ensemble == null)
        {
            return new Classifier[this.ensembleSizeOption.getValue()];
        }
    ...
    protected class StreamingRandomPatchesClassifier extends AbstractClassifier implements MultiClassClassifier{
